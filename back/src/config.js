module.exports = {
    queries: [
        ...
        "SELECT COUNT (*) FROM sishab WHERE txt_tfpotogfa = 'Casa Sobreposta'",
        ...
        "SELECT COUNT (*) FROM sishab WHERE txt_situacao_obra 'Obras Entregues' OR txt_situacao_obra = 'Obras Concludas'",
